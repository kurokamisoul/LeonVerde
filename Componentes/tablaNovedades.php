...
<div class="row">
    ...
    <font color=white><strong> 
		...
		<table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad" >
			...
			<tbody style="background-color:#FFFF!important; color:#000000">
                ...
                //$dato=$_POST['DatoBuscar'];
					...
					if(isset($_SESSION['consulta'])){
						...
						$sentencia=$pdo->prepare("SELECT id_novedad,id_libro,titulo FROM novedades");
					}
                 ...
                 foreach($listaProductos as $libro){
					 $id=$libro ['id_libro'];
					 $datos=$libro ['id_novedad']."||".$libro ['id_libro']."||".$libro ['titulo'];
					 ?>
			...
			<td>
				<button class="btn btn-danger glyphicon glyphicon-trash" onclick="confirmacionNovedades('<?php echo $id?>')"></button>
			</td>		
			</tr>
			 <?php } }else{
