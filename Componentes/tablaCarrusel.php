...
<div class="row">
    ...
    <font color=white><strong> 
		...
		<table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad" >
                ...
                //$dato=$_POST['DatoBuscar'];
					...
					if(isset($_SESSION['consulta'])){
						if($_SESSION['consulta']>0){
							...
							$sentencia=$pdo->prepare("SELECT id,nombre,imagen FROM carrusel");
						}
					}else{
						$sentencia=$pdo->prepare("SELECT id,nombre,imagen FROM carrusel");
					}
                 ...
                 foreach($listaProductos as $libro){
					 $id=$libro ['id'];
					 $datos=$libro ['id']."||".$libro ['nombre']."||".$libro ['imagen'];
					 ?>
			...
			<td>
				<button class="btn btn-danger glyphicon glyphicon-trash" onclick="confirmacionCarrusel('<?php echo $id?>')"></button>
			</td>		
			</tr>
			 <?php } }else{
