...
<div class="row">
    ...
    <font color=black><strong> 
		...
		<table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadN" >
			...
			<tbody style="background-color:#FFFF!important; color:#000000">
				 <?php 
					...
					$sentencia='';
						...
						$sentencia=$pdo->prepare("SELECT libros.id_libro,libros.titulo,libros.autor,libros.precio FROM ordenes 
                        LEFT JOIN detalle_orden ON ordenes.id_orden = detalle_orden.id_orden
                         LEFT JOIN libros ON detalle_orden.id_libro = libros.id_libro where ordenes.id_orden=$dato");
