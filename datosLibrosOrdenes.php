  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Detalles Ordenes</h4>
        
      </div>
      <div class="modal-body" id="tableLO">
      
      <input type="text" hidden="" id="id_orden" name="">
...
<script type="text/javascript">
	$(document).ready(function(){
     $('#table').load('Componentes/tablaOrdenes.php');
     $('#tableLO').load('Componentes/tablaLibrosOrdenes.php');
