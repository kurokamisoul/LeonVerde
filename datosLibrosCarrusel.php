  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" href="javascript:;" onclick="guardarCarrusel();return false;"
...
<script type="text/javascript">
	$(document).ready(function(){
     $('#table').load('Componentes/tablaCarrusel.php');
...
<script>
  function guardarCarrusel(){
    ...
    agregarDatosCarrusel($('#nombre').val(),$('#archivo').val());
   
    var formData = new FormData();
        var files = $('#archivo')[0].files[0];
        formData.append('file',files);
        $.ajax({
            url: 'uploadCarrusel.php',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
