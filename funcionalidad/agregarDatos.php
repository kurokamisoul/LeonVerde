...
$sql="INSERT INTO libros(piezas,precio,titulo,autor,descripcion,isbn,editorial,edicion,numero_paginas,imagen,fecha_alta)
 values (:piezas,:precio,:titulo,:autor,:descripcion,:isbn,:editorial,:edicion,:numero_paginas,:imagen,:fecha_alta);";
